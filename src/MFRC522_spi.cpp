 ...
 */
void MFRC522_SPI::PCD_WriteRegister(	PCD_Register reg,	///< The register to write to. One of the PCD_Register enums.
 ...
 * The interface is described in the datasheet section 8.1.2.
 */
byte MFRC522_SPI::PCD_ReadRegister(	PCD_Register reg	///< The register to read from. One of the PCD_Register enums.
								) {
	byte value;
	_spiClass->beginTransaction(_spiSettings);	// Set the settings to work with SPI bus
	digitalWrite(_chipSelectPin, LOW);			// Select slave
 ...
 * The interface is described in the datasheet section 8.1.2.
 */
void MFRC522_SPI::PCD_ReadRegister(	PCD_Register reg,	///< The register to read from. One of the PCD_Register enums.
...
void MFRC522_SPI::PCD_Init() {
	bool hardReset = false;
        ...
        if (!hardReset) { // Perform a soft reset if we haven't triggered a hard reset above.
                MFRC522_BASE::PCD_Reset();
        }
	MFRC522_BASE::PCD_Init();
}
